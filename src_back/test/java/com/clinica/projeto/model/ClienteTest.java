...
public class ClienteTest {
    ...
    public void testSetters() {
        ...
        // Dados de teste
        String name = "nick";
        String descricao = "shih-tzu, filhote, marrom";
        String foto = "https://petfisio.com.br/wp-content/uploads/2022/08/Dogue_alemao.webp";
        String categoria = "Cachorro";
        ...
        assertEquals(categoria, cliente.getCategoria());
        assertEquals(dataNascimento, cliente.getDataNascimento());
        assertFalse(cliente.isDisponivel());
    }
